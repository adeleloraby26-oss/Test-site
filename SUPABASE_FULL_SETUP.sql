...
-- ── CONVERSATIONS ─────────────────────────────────────────
-- FIX: استخدام user_a / user_b بدل user1_id / user2_id
...
-- FIX: Update conversation last_msg (using correct column names user_a/user_b)
...
-- FIX: CONVERSATIONS — use user_a / user_b column names
...
-- FIX: MESSAGES — read if in conversation (user_a/user_b)
